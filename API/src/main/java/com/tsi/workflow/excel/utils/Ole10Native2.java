...
public class Ole10Native2 {
    ...
    /**
     * Creates an instance of this class from an embedded OLE Object. The OLE Object
     * is expected to include a stream &quot;{01}Ole10Native&quot; which contains
     * the actual data relevant for this class.
     *
     * @param poifs
    ...
    /**
     * Returns the label field - usually the name of the file (without directory)
     * but probably may be any name specified during packaging/embedding the data.
     *
     * @return the label
     */
    ...
    /**
     * Returns the size of the embedded file. If the size is 0 (zero), no data has
     * been embedded. To be sure, that no data has been embedded, check whether
    ...
    /**
     * Have the contents printer out into an OutputStream, used when writing a file
     * back out to disk (Normally, atom classes will keep their bytes around, but
     * non atom classes will just request the bytes from their children, then chuck
     * on their header and return)
     */
