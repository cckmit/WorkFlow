...
public class InitCorsContext implements ServletContextListener {
	...
	System.out.println("CORS Loading Config : " + lConfigFile.getAbsolutePath());
	...
	System.out.println("CORS Profile : " + property);
	...
	String lsessionKey = propsFromFile.getProperty("wf.cache.session.key");
	System.out.println("Cache Session Key : " + lsessionKey);
    }
}
