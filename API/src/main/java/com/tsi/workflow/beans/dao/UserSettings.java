...
@NamedQueries({ @NamedQuery(name = "UserSettings.findAll", query = "SELECT u FROM UserSettings u") })
public class UserSettings extends BaseBeans implements Serializable {
	...
	return "com.tsi.workflow.beans.dao.UserSettings[ id=" + id + " ]";
    }
